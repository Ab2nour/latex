...
\begin{document}
    ...
    \section{Roles Description}
        ...
        \subsection{Pierre}
            ...
            He develops the mobile version of the game, and is in charge of everything related to programming. Every time a bug occurs, he is here to fix it. He conceives the cards, match their colors through the design he thinks, in order not to impair chess original style.
