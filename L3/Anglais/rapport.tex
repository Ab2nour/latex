...
\begin{document}
    ...
    \section{Webography}
        ...
        Chess Journal, \textit{A theorem on graphs, with an application to a problem on traffic control}, \href{https://www.chessjournal.com/why-is-chess-so-hard/}{\underline{Why Is Chess So Hard? Is It REALLY That Difficult?}}
