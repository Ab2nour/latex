...
\section{Séances}
    \subsection{1$^{\text{ère}}$ séance (20.01)}
        ...
        \subsubsection*{Résultats de la séance}
            ...
            %
            Pour les séries à VMA (15 km/h) : je suis arrivé au plot 15 (300 m) les 3 premières fois, puis entre les plots 14 et 15 les deux dernières fois.\\
            C'est ok au début, mais je commence à lâcher prise passé la troisième fois...\\\\
            %
            Pour le Seuil$^+$, 
