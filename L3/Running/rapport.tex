...
\end{tabularx}
    ...
    \label{sec:seance5}
        ...
        \subsubsection*{Résultats de la séance}
            ...
            Pour les 300 m, j'ai fait deux fois 1'09'', puis 1'07'', et pour finir, 1'02'' (17.5 km/h) sur le dernier... une belle accélération progressive !\\\\
            Pour les 250 m, j'ai été constant et efficace : 56'' systématiquement.
    ...
    \subsection{6$^{\text{ème}}$ séance (03.03)}
        ...
        \subsubsection*{Résultats de la séance}
            Mon objectif était de 45'' les 200 m soit 16 km/h.\\
            J'ai fait en moyenne 47'' (15.5 km/h), avec quelques réussites à 45'', et quelques ratés à 49''.
    ...
    \label{sec:seance7}
        ...
        \subsubsection*{Résultats de la séance}
            Mon objectif était de 13 tours (11 km/h).\\
            J'en ai fait 13 et demi ! (3.85 km, soit 11.5 km/h)\\
            Ce résultat me semble très impressionnant, moi qui ai plutôt des lacunes quand il s'agit de courir longtemps.\\\\
            Ici, le mental compte pour beaucoup, il faut savoir ne pas écouter la petite voix dans sa tête qui demande à s'arrêter...\\
            Selon moi, je dois pour beaucoup mon résultat au fait d'avoir couru ce footing à plusieurs (effet de boost !)\\
            Sans cela, je pense sincèrement que j'aurais fait uniquement 13 tours, donc mon objectif original.\\\\
            D'après moi, il s'agit plutôt d'une performance au-dessus de mon niveau habituel (j'étais à bout de souffle après l'effort), mais c'est aussi ça le sport, on se surpasse pendant certaines séances... c'est très encourageant.
    ...
    \subsection{8$^{\text{ème}}$ séance (17.03)}
        ...
        \subsubsection*{Résultats de la séance}
            Ici je tente une VMA$^+$ de 16 km/h comme habituellement, donc 300 m en 1'07'', et 250 m en 56''.\\\\
            %
            J'ai fait 1'07'' sur les 3 premiers, puis 1'09'' et 1'11''... je faiblis...\\\\
            Je me suis toutefois senti plus rapide sur les 250 m, en tout cas au début.\\
            J'ai fait 55'' 2-3 fois, puis la majorité à 57'', et sur la fin deux moins bonnes répétitions à 59''.
