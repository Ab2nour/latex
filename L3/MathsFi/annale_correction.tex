...
\\%
todo: Blabla on divise en deux
$$C^{'}_5 = C\cdot(i_1+1)^2\cdot(i_2+1)^3$$
...
$$\implies V^{deb}_{acq} = 12000\cdot  1.0075\cdot\dfrac{1.0075^4-1}{0.0075} = \boxed{48906.78\text{ \texteuro}}$$
\\%
\\%
...
Soit :
$$V'^{deb}_{acq} = 1000 \cdot 1.000623\cdot\dfrac{1.000623^{48}-1}{0.000623} = \boxed{48739.85\text{ \texteuro}}$$
On remarque que les deux placements ne sont pas équivalents : la stratégie annuelle est plus fructueuse que la stratégie mensuelle.
