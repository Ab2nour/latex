...
$$\implies V_2 = C_1 \cdot (i+1)^{2} + C_2 (i+1)$$
...
$$V_2 = (V_1 + C_2)\cdot (i+1)^n$$
On remplace $V_1$ par sa valeur $C_1 \cdot (i+1)^n$
$$ V_2 = (C_1 \cdot (i+1)^n + C_2)\cdot (i+1)^n$$
$$\implies V_2 = C_1 \cdot (i+1)^{2n} + C_2 (i+1)^n$$
$$\implies C_1 \cdot \Big((i+1)^{n}\Big)^2 + C_2 (i+1)^n - V_2 = 0$$
